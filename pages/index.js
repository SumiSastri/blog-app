...
export default function Home() {
  return (
    <><div className={styles.card1}>
      ...
      <Image style={{padding:"5px", margin: "10px"}}height={200} width={175} alt="The author Prema Sastri in 2007" src="/premasastriauthor2007.jpeg"/>
      <p><em>Prema Sastri – Preface, A Fine Gift From Lakshmi, 2007</em></p>

      <p>We are heroic, cowardly, hurt, passionate, kind or cruel at different moments.
      We know very little about ourselves, and still less about others.</p>
